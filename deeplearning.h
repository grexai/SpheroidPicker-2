...
public:
    ...
    std::vector<std::vector<float>> dnn_prediction(cv::Mat& input) ;
    virtual std::vector<std::vector<float>> dnn_prediction(cv::Mat& input,cv::Mat& output)= 0;
...
public:
    ...
    std::vector<std::vector<float>> dnn_prediction(cv::Mat& input);
    std::vector<std::vector<float>> dnn_prediction(cv::Mat& input,cv::Mat& output) override;
